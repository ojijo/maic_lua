...
cmd:option('-input_h5','./data/ai/ai_challenge.h5','path to the h5file containing the preprocessed dataset')
cmd:option('-input_json','./data/ai/ai_challenge.json','path to the json file containing additional info and vocab')

--cmd:option('-input_h5','./data/coco/cocotalk_challenge.h5','path to the h5file containing the preprocessed dataset')
--cmd:option('-input_json','./data/coco/cocotalk_challenge.json','path to the json file containing additional info and vocab')
...
cmd:option('-checkpoint_path', 'save-ai/', 'folder to save checkpoints into (empty = this folder)')
...
-- training setting
cmd:option('-nEpochs', 2, 'Max number of training epoch')
